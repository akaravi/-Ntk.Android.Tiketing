...
public class MainActivity_2 extends AbstractMainActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        menus.add(new GridMenu(getString(R.string.polling), R.drawable.bell));
        ...
        menus.add(new GridMenu(getString(R.string.aboutUs), R.drawable.about_us));
        menus.add(new GridMenu(getString(R.string.ticketing), R.drawable.support));
