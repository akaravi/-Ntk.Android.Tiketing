...
public class Animations {
    ...
    public static class FadeInListener extends FadeListener {
        ...
        public void onAnimationStart(Animator animation) {
            ...
            Log.i(ViewSwitcher.class.getSimpleName(), String.format("fadeIn START: %s", view.getContext().getResources().getResourceName(view.getId())));
        }
        ...
        public void onAnimationEnd() {
            ...
            if (view.getVisibility() != View.VISIBLE) {
                Log.i(ViewSwitcher.class.getSimpleName(), String.format("fadeIn END: %s", view.getContext().getResources().getResourceName(view.getId())));
                view.setVisibility(View.VISIBLE);
            }
        }
    }
    ...
    public static class FadeOutListener extends FadeListener {
        ...
        public void onAnimationStart(Animator animation) {
            super.onAnimationStart(animation);
            Log.i(ViewSwitcher.class.getSimpleName(), String.format("fadeOut START: %s", view.getContext().getResources().getResourceName(view.getId())));
        }
        ...
        public void onAnimationEnd() {
            view.setAlpha(0);
            if (view.getVisibility() == View.VISIBLE) {
                Log.i(ViewSwitcher.class.getSimpleName(), String.format("fadeOut END: %s", view.getContext().getResources().getResourceName(view.getId())));
